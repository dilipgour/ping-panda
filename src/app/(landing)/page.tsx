    ...
    <>
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="text-center">
          <div className="relative mx-auto text-center flex flex-col items-center gap-10">
            ...
            <p className="text-base/7 text-center text-pretty max-w-prose">
      ...
      <section className="relative py-24 sm:py-32 bg-brand-25">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          <div>
            <h2 className="text-center text-brand-600 text-base/7 font-semibold">
          ...
          <div className="grid lg:grid-cols-3 lg:grid-rows-2 gap-4">
            <div className="relative lg:row-span-2">
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                <div className="px-8 pb-3 sm:px-10 sm:pb-0 pt-8 sm:pt-10">
                  <p className="text-brand-950 tracking-tight text-lg/7 mt-2 font-medium max-lg:text-center ">
                ...
                <div className="relative min-h-[30rem] w-full grow [conatiner-type:inline-size] max-lg:mx-auto mx-lg:max-w-sm">
                  <div className="inset-x-10 absolute bottom-0 top-10 overflow-hidden rounded-t-[5cqw] border-x-[1cqw] border-t-[1cqw] border-gray-700 bg-gray-900 shadow-2xl">
                    <Image
              ...
              <div className="absolute inset-px rounded-lg bg-white lg:rounded-l-[2rem]">
                <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] lg:rounded-l-[calc(2rem+1px)]">
                  <div className="px-8 sm:px-10 pt-8 sm:pt-10">
                    ...
                    <p className="mt-2 max-w-lg text-sm/6 text-gray-600 max-lg:text-center">
                      From a new user signups to successfull payments, PingPanda
              ...
              <div className="relative flex h-full flex-col overflow-hidden rounded-[calc(theme(borderRadius.lg)+1px)] ">
                ...
                <div className="flex flex-1 items-center justify-center px-8 max-lg:pb-12 max-lg:pt-10 sm:px-10 lg:pb-2">
                  <Image
                    ...
                    alt="bento box custom data tracking"
                    width={500}
                    height={300}
                  />
                </div>
      ...
      <section className="relative py-24 sm:py-32 bg-white">
        <MaxWidthWrapper className="flex flex-col items-center gap-16 sm:gap-20">
          ...
          <div className="mx-auto space-x-1 grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 divide-y lg:divide-y-0 lg:divide-x divide-gray-200">
